export function getDefaultContent() {
  return {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              desc: 'Large-scale dry ration packets distribution drives (budgeting ₹46.06L in FY 2024-25 alone) to daily wage earners, widows, and flood survivors in Assam.',
    ...
    about: {
      meta: { title: 'About Us | Green Ahom Federation', slug: '/about', description: 'About Green Ahom Federation — Section 8 Non-Profit Company incorporated under Indian Companies Act 2013. Board of Directors, statutory compliance, Ideal Academy Hailakandi, and organizational governance.' },
      sections: [
        {
          id: 'about_hero',
          type: 'hero',
          ...
          items: [
            {
              ...
              din: '10415892',
              qualification: 'M.Com (Finance), Company Secretary (ICSI Student), CSR Professional Certification',
              experience: 'Over 5 years in social development, CSR project management, fundraising strategy, and grassroots institutional building. Instrumental in securing ONGC CSR partnerships and scaling GAF from ₹3.58L to ₹1.97Cr annual operations.',
              expertise: ['CSR Project Implementation', 'Fundraising & Resource Mobilization', 'Financial Management', 'Institutional Development', 'Strategic Partnerships']
            },
            {
              id: 'dir_2',
              ...
              din: '10415893',
              qualification: 'Graduate, Certified Field Operations Coordinator',
              experience: 'Extensive community development background spanning youth mobilization, athletic development programs, and field logistics coordination across Cachar and Hailakandi districts.',
              expertise: ['Community Mobilization', 'Youth Development', 'Field Operations', 'Logistics Management']
            },
            {
              id: 'dir_3',
              ...
              din: '10415894',
              qualification: 'Graduate, Women Empowerment Development Professional',
              experience: 'Passionate advocate for maternal nutrition and women empowerment with direct field experience in multi-district tailoring skill training programs and village handicraft development.',
              expertise: ['Women Empowerment', 'Maternal Health & Nutrition', 'Skill Training Programs', 'Handicraft Development']
            }
          ]
        },
        {
          ...
          status: 'published',
          badge: 'LEADERSHIP',
          heading: 'Founder & Managing Director',
          name_display: 'Shamil Emonar Rahman Laskar',
          designation: 'Founder Director & Subscriber',
          din: 'DIN: 10415892',
          qualifications: [
            'M.Com (Finance) — Assam University',
            'Company Secretary (ICSI) — Student Member',
            'CSR Professional Certification',
            'Development Sector Management'
          ],
          bio: 'Shamil Emonar Rahman Laskar is the founding force behind Green Ahom Federation. With a strong academic background in finance and corporate governance, he envisioned an organization that would combine statutory corporate discipline with grassroots humanitarian action. Under his leadership, GAF has grown from a ₹3.58 Lakh first-year operation to a ₹1.97 Crore multi-district development institution within three financial years.',
          achievements: [
            'Scaled GAF operations from ₹3.58L (FY 2022-23) to ₹1.97Cr (FY 2024-25) — a 55x growth',
            'Secured ONGC Silchar CSR partnership for TB patient nutrition (₹14.85L) and cataract surgery programs',
            'Led statutory acquisition of Ideal Academy, Hailakandi (UDISE: 18230124113) enrolling 364 underprivileged students',
            'Orchestrated construction of 3 community centres across Barpeta, Cachar, and Hailakandi districts',
            'Established multi-district women tailoring training programs empowering hundreds of rural women',
            'Coordinated emergency flood relief operations distributing dry rations worth ₹48.3L across 5 districts'
          ],
          csr_experience: [
            'CSR-1 Registered Implementation Agency management',
            'ONGC Silchar CSR project execution and audit compliance',
            'Multi-stakeholder CSR proposal development and reporting',
            'Schedule VII project design and beneficiary documentation',
            'GIS-tagged beneficiary mapping and third-party verification'
          ]
        },
        {
          id: 'about_academy',
    ...
    work: {
      meta: { title: 'Our Work | Green Ahom Federation', slug: '/work', description: 'Explore 20 verified grassroots programs executed by Green Ahom Federation across 7 districts of Assam. CSR projects spanning health, education, women empowerment, disaster relief, and rural infrastructure.' },
      sections: []
    },
    impact: {
      meta: { title: 'Impact | Green Ahom Federation', slug: '/impact', description: 'Measurable social impact dashboard — 12,500+ beneficiaries reached, 600+ women trained, 1,870+ TB patients supported, 364 students enrolled. Verified outcomes from CA-audited operations.' },
      sections: [
        {
          id: 'impact_hero',
          type: 'hero_simple',
        ...
        },
        {
          ...
          name: 'CSR Impact Dashboard',
          visible: true,
          order: 2.5,
          status: 'published',
          badge: 'MEASURABLE OUTCOMES',
          heading: 'Quantified Social Impact Indicators',
          subtitle: 'Evidence-based metrics derived from CA-audited financial statements and verified field beneficiary records across 3 financial years (FY 2022-23 to FY 2024-25).',
          indicators: [
            { label: 'Total Beneficiaries Reached', value: '12,500+', icon: 'beneficiaries', category: 'OUTREACH' },
            { label: 'Women Trained (Tailoring & Stitching)', value: '600+', icon: 'women', category: 'EMPOWERMENT' },
            { label: 'TB Patients Supported (Nutritional Aid)', value: '1,870+', icon: 'health', category: 'HEALTH' },
            { label: 'Students Enrolled (Ideal Academy)', value: '364', icon: 'education', category: 'EDUCATION' },
            { label: 'Pregnant Women & Infants Supported', value: '1,200+', icon: 'maternal', category: 'HEALTH' },
            { label: 'Eye Patients Screened & Treated', value: '500+', icon: 'eye', category: 'HEALTH' },
            { label: 'Districts Covered', value: '7', icon: 'districts', category: 'GEOGRAPHY' },
            { label: 'Community Centres Constructed', value: '3', icon: 'infrastructure', category: 'INFRASTRUCTURE' },
            { label: 'Villages & Blocks Reached', value: '85+', icon: 'villages', category: 'GEOGRAPHY' },
            { label: 'Programs Executed (3 Years)', value: '20', icon: 'programs', category: 'OPERATIONS' },
            { label: 'Total Audited Expenditure', value: '₹2.38 Crore', icon: 'funds', category: 'FINANCIAL' },
            { label: 'Stray Animals Fed & Rescued', value: '3,000+', icon: 'animal', category: 'WELFARE' }
          ]
        },
        {
          id: 'impact_slider',
        ...
        },
        {
          ...
          items: [
            { id: 'story-1', title: 'From Dropout to Dreams', author: 'Dilip Namasudra, Parent (Daily Wage Earner)', quote: 'My children were dropping out of school because I could not afford standard tuition fees. GAF\'s acquisition of Ideal Academy was a blessing. Today, my daughter studies in Class VIII with high-quality conceptual learning and hostel support, dreaming of becoming a doctor. The academy gave our family hope when we had none.', iconName: 'education', category: 'EDUCATION', impact: 'Daughter retained in school, now Class VIII with hostel support' },
            { id: 'story-2', title: 'TB Recovery Through Nutrition', author: 'Anjali Gogoi, Health Worker (ONGC CSR Program)', quote: 'Medical treatment alone is not enough to cure tuberculosis; rich nutritional care is critical. The high-protein ration packs that GAF distributes directly to our patient cohorts with ONGC Silchar support have successfully improved treatment adherence rates. Patients who previously defaulted on medication due to weakness are now completing their full course of treatment.', iconName: 'health', category: 'HEALTH', impact: '935 TB patients received nutritional support in Cachar & Hailakandi' },
            { id: 'story-3', title: 'A Mother\'s Lifeline in Luairpoa', author: 'Rina Begum, Lactating Mother (Karimganj)', quote: 'GAF distributed highly nutritious food supplements directly to 1,200 pregnant women and young children below three years in our Luairpoa area. During my pregnancy, I could barely afford one meal a day. The nutritional kits ensured my baby was born healthy with proper weight. It was a lifeline for mothers like me.', iconName: 'health', category: 'MATERNAL HEALTH', impact: '1,200 pregnant women and infants received nutritional kits' },
            { id: 'story-4', title: 'Stitching My Own Future', author: 'Fatima Khatun, Tailoring Graduate (Hailakandi)', quote: 'Before the GAF tailoring training, I was entirely dependent on my husband\'s daily wage income. After completing the 3-month intensive stitching course, I received my own sewing machine. Now I earn ₹4,000–6,000 per month stitching clothes for neighbors and local shops. I am financially independent for the first time in my life.', iconName: 'livelihoods', category: 'WOMEN EMPOWERMENT', impact: 'Now earns ₹4,000–6,000/month independently through tailoring' },
            { id: 'story-5', title: 'Sight Restored in Lala Block', author: 'Mohan Das, Retired Farmer (Hailakandi)', quote: 'I had been struggling with failing eyesight for years, unable to afford spectacles or surgery. During the GAF-ONGC eye camp at Lala Block, doctors diagnosed my cataracts and I was referred for fully sponsored surgery. Today I can see clearly again — I can recognize my grandchildren\'s faces. No one in our village had access to this kind of medical help before.', iconName: 'health', category: 'EYE CARE', impact: 'Cataract surgery fully sponsored, vision restored' },
            { id: 'story-6', title: 'Flood Survivors Fed in NC Hills', author: 'Bikram Singha, SHG Leader (Dima Hasao)', quote: 'When the floods devastated our village in NC Hills, everything was submerged. GAF teams arrived within days with rice, dal, oil, and sugar packets. For two weeks, those dry rations were the only food source for 200 families in our area. Without GAF\'s rapid response, many families including children and elderly would have gone hungry.', iconName: 'relief', category: 'DISASTER RELIEF', impact: '200+ families received emergency dry ration kits during floods' }
          ]
        },
        {
          id: 'impact_cta',
    ...
    gallery: {
      meta: { title: 'Gallery | Green Ahom Federation', slug: '/gallery', description: 'Visual documentation of Green Ahom Federation field operations — plantation drives, health camps, tailoring training, community development, and humanitarian relief across Assam.' },
      sections: [
        {
          id: 'gallery_hero',
          type: 'hero_simple',
    ...
    partners: {
      meta: { title: 'Partners | Green Ahom Federation', slug: '/partners', description: 'CSR Partnerships — Green Ahom Federation collaborates with ONGC Silchar CSR, district administrations, BH College, and healthcare institutions. CSR-1 registered implementing agency.' },
      sections: [
        {
          id: 'partners_hero',
          type: 'hero_simple',
        ...
        },
        {
          ...
          items: [
            { id: 'csr1', title: 'MCA CSR-1 Implementing Agency', desc: 'GAF is officially registered (CSR00029857) with the Ministry of Corporate Affairs to execute CSR projects under Section 135 of the Indian Companies Act, 2013.', regNo: 'CSR00029857' },
            { id: '80g', title: '80G Tax Exemption Certificate', desc: 'Registration No. AADCG7297LG20241 — Allows GAF\'s corporate and individual patrons to claim 50% tax deductions on all charity donations under Section 80G.', regNo: 'AADCG7297LG20241' },
            { id: '12a', title: '12A Non-Profit Registration', desc: 'Registration No. AADCG7297LF20241 — Registered under Section 12A of the Income Tax Act, 1961, establishing GAF\'s verified tax-free charity status.', regNo: 'AADCG7297LF20241' },
            { id: 'companiesAct', title: 'Section 8 Company (CIN)', desc: 'CIN: U85300AS2022NPL022387 — Strict dividend distribution prohibition, ensuring 100% of mobilized budgets directly support field projects.', regNo: 'U85300AS2022NPL022387' },
            { id: 'darpan', title: 'NGO Darpan / NITI Aayog', desc: 'Unique ID: AS/2022/0311876 — Registered on the NITI Aayog portal for government grant eligibility and institutional recognition.', regNo: 'AS/2022/0311876' },
            { id: 'pan', title: 'PAN & Tax Identity', desc: 'PAN: AADCG7297L — Active Permanent Account Number for all tax compliance, TDS, and financial audit requirements.', regNo: 'AADCG7297L' }
          ]
        },
        {
          ...
          items: [
            ...
            { name: 'District Administration, Hailakandi', role: 'Government Implementation Partner', desc: 'Active coordination with the District Administration for implementation of community development programs, including flood relief distribution, plantation drives, and public health camp logistics across Hailakandi blocks.', badge: 'HAILAKANDI ADMIN', logoText: 'HDA' },
            { name: 'District Administration, Cachar', role: 'Government Coordination Partner', desc: 'Facilitated implementation of street light installation programs, community centre construction, and humanitarian relief distribution across Sonai, Dholai, and Borkhola blocks.', badge: 'CACHAR ADMIN', logoText: 'CDA' },
            { name: 'Block Primary Health Centres (Barak Valley)', role: 'Public Health Delivery Partner', desc: 'Coordinated with Block PHCs in Lala, Algapur, and Patharkandi for TB patient identification, nutritional supplement distribution, and cataract surgery referral pipelines.', badge: 'PHC NETWORK', logoText: 'PHC' },
            { name: 'National Service Scheme (NSS) Units', role: 'Youth Volunteer Mobilization Partner', desc: 'Collaboration with NSS units of local colleges for World Environment Day plantation drives, blood donation camps, and community awareness campaigns across Barak Valley.', badge: 'NSS UNITS', logoText: 'NSS' }
          ]
        },
        {
          id: 'partners_cta',
    ...
    volunteer: {
      meta: { title: 'Volunteer | Green Ahom Federation', slug: '/volunteer', description: 'Volunteer with Green Ahom Federation — Join grassroots development missions in Assam. Community mobilization, environmental action, health outreach, and digital advocacy roles available.' },
      sections: [
        {
          id: 'volunteer_hero',
          type: 'hero_simple',
    ...
    donate: {
      meta: { title: 'Donate | Green Ahom Federation', slug: '/donate', description: 'Support Green Ahom Federation — Donate to fund education for underprivileged children, TB patient nutrition, flood relief, and women empowerment programs. 80G tax exemption available.' },
      sections: [
        {
          id: 'donate_hero',
          type: 'hero_simple',
    ...
    contact: {
      meta: { title: 'Contact Us | Green Ahom Federation', slug: '/contact', description: 'Contact Green Ahom Federation for CSR partnerships, volunteering, corporate collaborations, and project inquiries. GAF Secretariat, Guwahati, Assam.' },
      sections: [
        {
          id: 'contact_hero',
          type: 'hero_simple',
    ...
    reports: {
      meta: { title: 'Annual Reports | Green Ahom Federation', slug: '/annual-reports', description: 'Annual Reports, financial audits, statutory certificates, and governance disclosures by Green Ahom Federation. Download CA-audited financial statements and compliance documents.' },
      sections: [
        {
          id: 'reports_hero',
          type: 'hero_simple',
        ...
        },
        {
          ...
          items: [
            ...
            { year: 'REG', title: 'CSR-1 Registration Certificate', summary: 'Official Ministry of Corporate Affairs CSR-1 Registration certifying Green Ahom Federation as an eligible implementing agency under Section 135 of the Companies Act, 2013. Registration No: CSR00029857.', metrics: 'CSR-1 Registration | MCA Certified | Section 135 Compliance', fileUrl: null, size: 'Available on Request', type: 'CSR Certificate' },
            { year: 'REG', title: '12A & 80G Tax Exemption Certificates', summary: 'Income Tax Department certificates establishing GAF\'s non-profit status under Section 12A (Registration: AADCG7297LF20241) and donor tax deduction eligibility under Section 80G (Registration: AADCG7297LG20241).', metrics: '12A Non-Profit Status | 80G Donor Exemption | IT Act 1961', fileUrl: null, size: 'Available on Request', type: 'Tax Certificate' },
            { year: 'REG', title: 'NGO Darpan / NITI Aayog Registration', summary: 'NITI Aayog official registration under the NGO Darpan portal establishing GAF\'s eligibility for government grants and institutional partnerships. Unique ID: AS/2022/0311876.', metrics: 'NITI Aayog Registered | Government Grant Eligible | Darpan ID', fileUrl: null, size: 'Available on Request', type: 'Government Registration' },
            { year: 'REG', title: 'Certificate of Incorporation (Section 8)', summary: 'Ministry of Corporate Affairs official incorporation certificate for Green Ahom Federation as a Section 8 Company limited by shares. CIN: U85300AS2022NPL022387. PAN: AADCG7297L. Incorporated: 14 September 2022.', metrics: 'CIN: U85300AS2022NPL022387 | Section 8 Company | ROC Shillong', fileUrl: null, size: 'Available on Request', type: 'Incorporation' },
            { year: 'PROFILE', title: 'Organizational Profile & CSR Portfolio', summary: 'Comprehensive organizational capability document for CSR committee evaluation. Includes: organizational overview, governance structure, CSR implementation track record, financial summaries, project management capabilities, and partnership proposal framework.', metrics: 'CSR Portfolio | Institutional Profile | Due Diligence Ready', fileUrl: null, size: 'Available on Request', type: 'CSR Profile' }
          ]
        },
        {
          id: 'reports_cta',
