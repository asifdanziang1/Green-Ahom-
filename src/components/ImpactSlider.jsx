  ...
  return (
    <div className="impact-slider-outer">
      ...
      <style>{`
        ...
        .green-canopy-visual {
          background: linear-gradient(135deg, #0F1D19 0%, #152C25 50%, #1D332D 100%);
        }
        ...
        .leaf-1 { width: 300px; height: 300px; top: -50px; right: -50px; background: radial-gradient(circle, rgba(var(--primary-rgb), 0.4) 0%, transparent 70%); }
        .leaf-2 { width: 250px; height: 250px; bottom: -50px; left: 10%; background: radial-gradient(circle, rgba(var(--primary-rgb), 0.6) 0%, transparent 80%); }
